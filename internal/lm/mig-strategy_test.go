	...
	testCases := []struct {
		...
		},
		{
			...
			expectedLabels: Labels{
				...
				"nvidia.com/gb10.replicas":         "1",
				"nvidia.com/gb10.sharing-strategy": "none",
				"nvidia.com/gb10.memory":           "300",
				"nvidia.com/gb10.product":          "MOCKMODEL",
			},
		},
		{
			...
			expectedLabels: Labels{
				...
				"nvidia.com/gb10.family":           "ampere",
				"nvidia.com/gb10.count":            "1",
				"nvidia.com/gb10.replicas":         "2",
				"nvidia.com/gb10.sharing-strategy": "time-slicing",
				"nvidia.com/gb10.memory":           "300",
				"nvidia.com/gb10.product":          "MOCKMODEL-SHARED",
			},
		},
		{
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedLabels: Labels{
				...
				"nvidia.com/gb10.replicas":         "1",
				"nvidia.com/gb10.sharing-strategy": "none",
				"nvidia.com/gb10.memory":           "100",
				"nvidia.com/gb10.product":          "MOCKMODEL-MIG-1g.100gb",
				"nvidia.com/mig.strategy":            "single",
				"nvidia.com/gb10.multiprocessors":  "0",
				"nvidia.com/gb10.slices.gi":        "1",
				"nvidia.com/gb10.slices.ci":        "2",
				"nvidia.com/gb10.engines.copy":     "0",
				"nvidia.com/gb10.engines.decoder":  "0",
				"nvidia.com/gb10.engines.encoder":  "0",
				"nvidia.com/gb10.engines.jpeg":     "0",
				"nvidia.com/gb10.engines.ofa":      "0",
			},
		},
		{
			...
			expectedLabels: Labels{
				...
				"nvidia.com/gb10.product":          "MOCKMODEL-MIG-1g.100gb",
				"nvidia.com/mig.strategy":            "single",
				"nvidia.com/gb10.multiprocessors":  "12",
				"nvidia.com/gb10.slices.gi":        "1",
				"nvidia.com/gb10.slices.ci":        "2",
				"nvidia.com/gb10.engines.copy":     "13",
				"nvidia.com/gb10.engines.decoder":  "14",
				"nvidia.com/gb10.engines.encoder":  "15",
				"nvidia.com/gb10.engines.jpeg":     "16",
				"nvidia.com/gb10.engines.ofa":      "17",
			},
		},
		{
			...
			isInvalid: true,
			expectedLabels: Labels{
				"nvidia.com/gb10.count":            "0",
				"nvidia.com/gb10.replicas":         "0",
				"nvidia.com/gb10.sharing-strategy": "",
				"nvidia.com/gb10.memory":           "0",
				"nvidia.com/gb10.product":          "MOCKMODEL-MIG-INVALID",
				"nvidia.com/mig.strategy":            "single",
			},
		},
		{
