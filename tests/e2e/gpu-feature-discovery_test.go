...
var expectedLabelPatterns = k8sLabels{
	...
	"nvidia.com/gb10.machine":          ".*",
	"nvidia.com/gb10.count":            "[0-9]+",
	"nvidia.com/gb10.replicas":         "[0-9]+",
	"nvidia.com/gb10.sharing-strategy": "[none|mps|time-slicing]",
	"nvidia.com/gb10.product":          "[A-Za-z_-]+",
	"nvidia.com/gb10.memory":           "[0-9]+",
	"nvidia.com/gb10.family":           "[a-z]+",
	"nvidia.com/mig.capable":          "[true|false]",
	"nvidia.com/gb10.compute.major":    "[0-9]+",
	"nvidia.com/gb10.compute.minor":    "[0-9]+",
